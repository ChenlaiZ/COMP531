...
function createElement(node) {
    ...
    if(node.props !== null){
        Object.keys(node.props).forEach(function eventfunc(key){
            if(key === "onClick"){
...
function updateElement(parent, newNode, oldNode, index=0) {
    ...
    if (!oldNode) {
        ...
        if (changed(newNode, oldNode)) {
            var childelement = createElement(newNode);
            Array.prototype.splice(parent.children, index, 0, childelement);
