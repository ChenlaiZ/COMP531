...
if (!process.env.CLOUDINARY_URL) {
     process.env.CLOUDINARY_URL="cloudinary://179347843865696:aemIGrvCWXXh-pgrNuOHjAJmtwo@hw3wkg9wg"
}
	...
	multer().single('text')(req, res, () => {
		if (!req.body.text) {
			req.textMsg = null;
     		...
     		req.textMsg = 'Please include text here'
     	} else {
     		req.textMsg = req.body.text[0];
     	}
    })
...
///////////////////////////////////////////////////////////////////////////////
// These two functions are examples to validate that uploading works
...
module.exports = uploadTextAndImage
